...
public class NespressoController {
   ...
   //update method 
	...
	public ResponseEntity<Nespresso> delete(@PathVariable Long id){
	    return this.s.deleteNespresso(id) ? new ResponseEntity<>(HttpStatus.NO_CONTENT) : new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);}}
